...
## Prepare the 4d radar dataset
Prepare your own dataset, and modify the dataset path in "tools/cfgs/dataset_configs/radar4d_dataset.yaml"
...
```python
python -m pcdet.datasets.kitti.kitti_dataset create_kitti_infos tools/cfgs/dataset_configs/radar4d_dataset.yaml
```

## How to train
```python
python train.py --cfg_file cfgs/kitti_models/radar_object_detection.yaml --extra_tag radar_detection_all
```

## How to test
```python
python test.py --cfg_file cfgs/kitti_models/radar_object_detection.yaml --batch_size 1 --eval_tag radar_detection_all --ckpt ../output/kitti_models/radar_object_detection/radar_detection_all/ckpt/checkpoint_epoch_80.pth --save_to_file
```

## How to export the trained model
```python
python convert2libtorch.py --ckpt ../output/kitti_models/radar_object_detection/radar_detection_all/ckpt/checkpoint_epoch_80.pth --output_path ./radar_detection_all.zip
```
